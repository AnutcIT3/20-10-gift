# Hướng dẫn kỹ thuật — Sổ lưu bút 20/10

Tài liệu cho người chạy, sửa và vận hành trang: cài đặt, chạy trên máy, chia sẻ
link, Face ID, cấu hình, API và scripts. Món quà này là gì và vì sao có nó thì
đọc ở [README.md](README.md).
